package milas_andmetric_gastronomi_mod.world.features.treedecorators;
...
@EventBusSubscriber
public class BosquepersaLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<BosquepersaLeaveDecorator> CODEC = MapCodec.unit(BosquepersaLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("milas_and_metric_gastronomy_mod:bosquepersa_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public BosquepersaLeaveDecorator() {
		super(0.25f);
	}
