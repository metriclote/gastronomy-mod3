...
@EventBusSubscriber
public class BosquepersaTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<BosquepersaTrunkDecorator> CODEC = MapCodec.unit(BosquepersaTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("milas_and_metric_gastronomy_mod:bosquepersa_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
