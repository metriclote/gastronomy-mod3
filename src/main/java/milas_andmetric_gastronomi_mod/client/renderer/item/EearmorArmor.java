...
public class EearmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, MilasAndMetricGastronomyModModItems.EEARMOR_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("milas_and_metric_gastronomy_mod:textures/models/armor/aa_layer_1.png");
			}
		}, MilasAndMetricGastronomyModModItems.EEARMOR_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("milas_and_metric_gastronomy_mod:textures/models/armor/aa_layer_2.png");
			}
		}, MilasAndMetricGastronomyModModItems.EEARMOR_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("milas_and_metric_gastronomy_mod:textures/models/armor/aa_layer_1.png");
			}
		}, MilasAndMetricGastronomyModModItems.EEARMOR_BOOTS.get());
	}
}