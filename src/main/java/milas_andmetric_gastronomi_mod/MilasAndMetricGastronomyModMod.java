package milas_andmetric_gastronomi_mod;
...
import milas_andmetric_gastronomi_mod.world.features.StructureFeature;
...
public class MilasAndMetricGastronomyModMod {
	public static final Logger LOGGER = LogManager.getLogger(MilasAndMetricGastronomyModMod.class);
	public static final String MODID = "milas_and_metric_gastronomy_mod";

	public MilasAndMetricGastronomyModMod(IEventBus modEventBus) {
		...
		MilasAndMetricGastronomyModModVillagerProfessions.PROFESSIONS.register(modEventBus);
		MilasAndMetricGastronomyModModFluids.REGISTRY.register(modEventBus);
		MilasAndMetricGastronomyModModFluidTypes.REGISTRY.register(modEventBus);
