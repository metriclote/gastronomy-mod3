...
public class ReynaguacaEntity extends Monster {
	...
	public ReynaguacaEntity(EntityType<ReynaguacaEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, CaveSpider.class, false, false));
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, Spider.class, false, false));
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, OllitaEntity.class, false, false));
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, OllitacchuleEntity.class, false, false));
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(MilasAndMetricGastronomyModModItems.AGUACATEENCANTADO.get()));
	}
