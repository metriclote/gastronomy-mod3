...
public class DumplingiganteEntity extends Monster {
	...
	public DumplingiganteEntity(EntityType<DumplingiganteEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(MilasAndMetricGastronomyModModItems.GRANDDUMPLING.get()));
	}
