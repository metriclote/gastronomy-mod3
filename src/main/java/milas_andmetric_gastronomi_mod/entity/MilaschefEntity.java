...
import milas_andmetric_gastronomi_mod.procedures.ChefoProcedure;
import milas_andmetric_gastronomi_mod.procedures.ChefeffectProcedure;

public class MilaschefEntity extends PathfinderMob {
	...
	public MilaschefEntity(EntityType<MilaschefEntity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, ChefEntity.class, false, false));
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, ReynaguacaEntity.class, false, false));
	...
	public void awardKillScore(Entity entity, DamageSource damageSource) {
		...
		ChefeffectProcedure.execute(entity);
	}
