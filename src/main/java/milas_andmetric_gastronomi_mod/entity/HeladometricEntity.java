...
public class HeladometricEntity extends TamableAnimal {
	public HeladometricEntity(EntityType<HeladometricEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.of(MilasAndMetricGastronomyModModItems.JUGOMETRIC.get()), false));
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(MilasAndMetricGastronomyModModItems.HELADO_7.get()));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HeladometricEntity retval = MilasAndMetricGastronomyModModEntities.HELADOMETRIC.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(MilasAndMetricGastronomyModModItems.JUGOMETRIC.get()).test(stack);
	}
