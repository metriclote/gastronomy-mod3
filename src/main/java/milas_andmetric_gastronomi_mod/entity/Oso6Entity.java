...
public class Oso6Entity extends TamableAnimal {
	...
	public Oso6Entity(EntityType<Oso6Entity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new TemptGoal(this, 1, Ingredient.of(MilasAndMetricGastronomyModModItems.GOMITA_5.get()), false));
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(MilasAndMetricGastronomyModModItems.GOMITA_6.get()));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		Oso6Entity retval = MilasAndMetricGastronomyModModEntities.OSO_6.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(MilasAndMetricGastronomyModModItems.GOMITA_5.get()).test(stack);
	}
